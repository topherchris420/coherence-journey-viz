	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%': { textShadow: '0 0 5px hsl(var(--primary)), 0 0 10px hsl(var(--primary)), 0 0 15px hsl(var(--primary))' },
					'100%': { textShadow: '0 0 10px hsl(var(--primary)), 0 0 20px hsl(var(--primary)), 0 0 30px hsl(var(--primary))' }
				}
			},
			animation: {
